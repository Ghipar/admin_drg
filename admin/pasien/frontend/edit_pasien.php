                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="container">
                                        ...
                                        <form method="post" action="../backend/edit_pasien.php?id=<?php echo $_GET['id'] ?>">
                                            <?php
                                            $id = $_GET['id'];
                                            $q = "SELECT * FROM tbl_pasien where id_pasien = $id";
                                            ...
                                            <?php while ($data = mysqli_fetch_array($run)) { ?>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" id="hp" name="hp" placeholder="Masukkan no handphone (WA)" value="<?php echo $data['no_hp'] ?>" required>
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" id="tgl_periksa" name="tgl_periksa" value="<?php echo $data['tgl_periksa'] ?>" required>
                                                </div>
                                                <div>
                                                    <label for="jenisKelamin" class="form-label">Jenis Kelamin</label>
                                                    <select style="margin-left: 10px;" class="form-select" id="jenisKelamin" name="jenisKelamin" value="" required>
