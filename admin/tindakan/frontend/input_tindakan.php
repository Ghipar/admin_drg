                  ...
                  <div class="container">
                    ...
                    <form method="post" action="../backend/insert_tindakan.php">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan harga (Rp)" required>
                      </div>
                      <div class="mb-3">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <?php
                      $query1 = "SELECT * FROM `tbl_tindakan`";
                        ...
                        <tbody>
                          <?php while ($data = mysqli_fetch_array($tampil)) { ?>
                            <tr>
                              ...
                              <td>
                                <a href="edit_tindakan.php?id=<?php echo $data['id_tindakan']; ?>"><i class="fa-solid fa-pen-to-square"></i></a> <?php ?> <a href="javascript:checkDelete(<?php echo $data['id_tindakan']; ?>);"><i class="fa-solid fa-trash" style="color: red; margin-left: 5px;"></i></a>
                              </td>
                            </tr>
                          <?php
  ...
  <script language="JavaScript" type="text/javascript">
    function checkDelete(x) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          return window.location = "../backend/hapus_tindakan.php?id=" + x;
        }
      })
    }
  </script>
